...
// import { applyPolyfills, defineCustomElements } from '@foobaz/components/loader';
//
const styles = {
...
//   }
//
//   const applyStencil = iframeNode => {
// 	  applyPolyfills().then(() => {
// 		  defineCustomElements(iframeNode.contentWindow);
// 	  });
//   }
//
...
// }
export const IframeWrapper = ({ children, showingCode }) => {
	return <div style={styles.iframe('auto', showingCode)}>{children}</div>
}
